...
public interface Constants {
  ...
  // CPU Voltage
    ...
    String FRANCO_HANDSET_MICROPONE_BOOST = "/sys/devices/virtual/misc/soundcontrol/dev_mic_boost";
    ...
    String[] HANDSET_MICROPONE_GAIN_ARRAY = {HANDSET_MICROPONE_GAIN, FRANCO_HANDSET_MICROPONE_BOOST};

    String[][] SOUND_ARRAY = {SPEAKER_GAIN_ARRAY, SOUND_CONTROL_ENABLE, WCD_HIGHPERF_MODE_ENABLE, HEADPHONE_GAIN, CAM_MICROPHONE_GAIN_ARRAY, HANDSET_MICROPONE_GAIN_ARRAY, {HIGHPERF_MODE_ENABLE,
            HEADPHONE_POWERAMP_GAIN, MIC_BOOST, VOLUME_BOOST, WCD_SPKR_DRV_WRND}};
