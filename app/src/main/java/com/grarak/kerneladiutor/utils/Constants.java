...
public interface Constants {
  ...
  // CPU Voltage
    ...
    String[][] SOUND_ARRAY = {SPEAKER_GAIN_ARRAY, SOUND_CONTROL_ENABLE, WCD_HIGHPERF_MODE_ENABLE, HEADPHONE_GAIN, CAM_MICROPHONE_GAIN_ARRAY, {HIGHPERF_MODE_ENABLE, HANDSET_MICROPONE_GAIN,
